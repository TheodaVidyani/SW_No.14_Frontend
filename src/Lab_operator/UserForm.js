...
const UserForm = ({ addUser, updateUser, submitted, data, isEdit }) => {
  ...
  const fetchTestTubes = async () => {
    try {
      const response = await axios.get('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/test_tubes');
  ...
  const fetchPatientNameAndAppointments = async (nic) => {
    try {
      ...
      const response = await axios.get('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/users');
