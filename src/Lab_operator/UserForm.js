...
const UserForm = ({ addUser, updateUser, submitted, data, isEdit }) => {
  ...
  const fetchTestTubes = async () => {
    try {
      const response = await axios.get('https://helthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/test_tubes');
  ...
  const fetchAppointments = async (userId) => {
    try {
      ...
      const response = await axios.get('https://helthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/appointments');
  ...
  const fetchPatientNameAndAppointments = async (nic) => {
    try {
      ...
      const response = await axios.get('https://helthlabback-git-vercelback-bytebuzzers-projects.vercel.app/users');
