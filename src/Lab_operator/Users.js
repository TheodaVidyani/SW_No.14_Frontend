...
const Users = () => {
    ...
    const getUsers = () => {
        Axios.get('https://helthlabback.vercel.app/api/testing-users')
            .then(response => {
    ...
    const addUser = (data) => {
        ...
        Axios.post('https://helthlabback.vercel.app/api/create-testing-user', payload)
        .then(() => {
            getUsers();
            setSubmitted(false);
            setIsEdit(false);
    ...
    const updateUser = (data) => {
        ...
        Axios.post('https://helthlabback.vercel.app/api/update-testing-user', payload)
        .then(() => {
            getUsers();
            setSubmitted(false);
        })
    ...
    const deleteUser = (data) => {
        Axios.delete('https://helthlabback.vercel.app/api/delete-testing-user', { data })
        .then(() => {
            getUsers();
        })
        .catch(error => {
