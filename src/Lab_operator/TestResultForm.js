...
const TestResultForm = ({ testresult, updateResults, submitted, data, isEdit }) => {
    ...
    const fetchAppointmentIds = () => {
        axios.get('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/appointmentIds')
            .then(response => {
    ...
    const fetchPatientDetails = (appointmentId) => {
        axios.get(`https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/appoinments/${appointmentId}`)
            .then(response => {
    ...
    const handleAfterSubmit = () => {
        ...
        axios.post('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/updateappointment', { id: id, state: 'result_add' })
            .then(response => {
