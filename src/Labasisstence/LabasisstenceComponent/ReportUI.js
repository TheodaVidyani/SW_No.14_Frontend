...
const ReportUI = () => {
  ...
  useEffect(() => {
    async function getUserDataByID() {
      const response = await fetch(`https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/getuser/${record.pid}`);
      if (!response.ok) {
  ...
  useEffect(() => {
    async function getResult() {
      const response = await fetch(`https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/testresult`);
      if (!response.ok) {
        setAlertMessage(`An error occurred: ${response.statusText}`);
        setAlertType("error");
        setShowAlert(true);
  ...
  useEffect(() => {
    async function getResult() {
      const response = await fetch(`https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/getrecomandationbyid/${record.id}`);
      if (!response.ok) {
        setAlertMessage(`An error occurred: ${response.statusText}`);
        setAlertType("error");
        setShowAlert(true);
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.put('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/updatdata', {
