...
export default function Patienthead() {
  ...
  const handleLogoutClick = async () => {
    ...
    try {
      await axios.post('https://healthlabbackend.vercel.app/api/router_login/logout'); // Call backend logout route
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await axios.get('https://healthlabbackend.vercel.app/api/router_login/getCurrentUser', {
          headers: {
