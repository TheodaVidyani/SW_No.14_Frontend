...
const FixedContainer = () => {
  ...
  const fetchPatientId = async (reportId) => {
    try {
      const response = await axios.get(`https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/patientId/${reportId}`);
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/recommendations', {
        date: selectedDate,
        id: rid,
        recommendation: msg,
  ...
  const handleAfterSubmit = async () => {
    try {
      await axios.post('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/updateappointment', { id: rid, state: 'Doctor_approved' });
  ...
  const handleApprove = async () => {
    try {
      const response = await axios.post('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/approve', {
        reportId: rid,
  ...
  const handleRecheck = async () => {
    try {
      const response = await axios.post('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/recheck', {
        reportId: rid,
        doctorName: jwtDecode(localStorage.getItem("myToken")).name,
        recommendation: msg,
        patientId: pid,
