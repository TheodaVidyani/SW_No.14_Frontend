...
export default function Dhome02() {
  ...
  const fetchAppointmentIds = () => {
    axios.get('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/appointmentId')
      .then(response => {
    ...
    <Box sx={{ width: '79%', margin: 'auto', backgroundColor: '#D9D9D9', padding: '20px', borderRadius: '8px' }}>
      ...
      <Button
        ...
        sx={{
          ...
          width: '80%',
          height: '52px',
          marginLeft: { xs: '10px', md: '150%' }, // Adjust margins for different screen sizes
        }}
      >
        View Report
      </Button>
