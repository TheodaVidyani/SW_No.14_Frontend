...
export default function StickyHeadTable() {
  ...
  useEffect(() => {
    axios.get('https://helthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/appointments')
      .then(response => {
  ...
  const handleLinkClick = (event, value, state) => {
    ...
    if (state === 'Doctor_approved' && jwtDecode(localStorage.getItem("myToken")).role === 'PATIENT') {
      axios.post('https://helthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/updateappointment', { id: value, patientView: 'viewed' })
        .then(response => {
