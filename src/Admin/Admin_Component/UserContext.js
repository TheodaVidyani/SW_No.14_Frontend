...
export const UserProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    axios.get('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/router_login/getCurrentUser', { withCredentials: true })
      .then(response => {
  ...
  const logout = () => {
    axios.post('https://healthlabback-git-vercelback-bytebuzzers-projects.vercel.app/api/router_login/logout', {}, { withCredentials: true })
      .then(() => {
        setUser(null);
      })
      .catch(error => {
